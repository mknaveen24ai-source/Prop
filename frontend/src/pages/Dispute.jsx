...
export default function Dispute({ user, accounts }) {
  ...
  return (
    <div className="trader-service-page trader-dispute-page">
      <h2 className="trader-service-title">
        Dispute / Appeal
      </h2>
      <p className="trader-service-subtitle">
              ...
              {eligibleAccounts.length === 0 ? (
                ...
                <div>
                    ...
                    <div className="service-choice-grid">
                      {DISPUTE_REASONS.map(r => (
                        <button
                          ...
                          className={`service-choice-button ${form.reason === r.value ? 'is-active' : ''}`}
                        >
                          {r.label}
                        </button>
                      ))}
                  ...
                  <div className="input-group">
                    ...
                    <textarea
                      className="textarea-field service-textarea"
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="btn btn-primary service-submit-button"
                  >
